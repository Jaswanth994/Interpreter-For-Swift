...
abstract class Stmt {
    interface Visitor<R> {
        ...
        R visitrepeat_WhileStmt(repeat_While stmt);
  ...
  static class If extends Stmt {
    ...
    static class repeat_While extends Stmt {
        repeat_While(Expr condition,Stmt body){
            this.condition=condition;
            this.body=body;
        }
         <R> R accept(Visitor<R> visitor) {
            return visitor.visitrepeat_WhileStmt(this);
        }
        final Expr condition;
        final Stmt body;
